...
![图 1 技能执行流程示意](assets/skill-flow.png)
图片来源：本地测试脚本生成，非实验结果证据。
图片宽度：12.8cm

图 1 只用于测试插图流程。图中箭头经过 Review And Revise：起点、终点、方向和文字区域均不重叠。
...
测试样例覆盖了近期指出的核心风险：错误事实口径、图像箭头可读性、AI 图像文字审核、模板残留、目录字段和最终渲染验证。真实课程报告仍应使用实际任务书、运行日志、截图和源代码证据替换本样例数据。
